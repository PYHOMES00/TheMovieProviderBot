...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://newboiz95:sc0UFQBGhcgSppI3@cluster0.anfyc1e.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
URL = "https://smk-movie-provider-a4d26abe6d62.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://smk-movie-provider-a4d26abe6d62.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://smk-movie-provider-a4d26abe6d62.herokuapp.com/".format(FQDN)
else:
    URL = "https://smk-movie-provider-a4d26abe6d62.herokuapp.com/".format(FQDN)
