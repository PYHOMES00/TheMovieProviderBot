...
API_ID = int(environ.get('API_ID', '26072691'))
API_HASH = environ.get('API_HASH', '17195c584a1d40ede0d41cd883124895')
BOT_TOKEN = environ.get('BOT_TOKEN', "7003982337:AAHEZLPehdtzgkhQURf948Tdsr6VlxPA9zk")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002012750856').split()] #Channel id for auto indexing ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jyotimaurya891824:qLp4PyOuMdYV5N7i@jyotimaurya.lobx8n6.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "jyotimaurya")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Verify
VERIFY = bool(environ.get('VERIFY', True)) # Verification On ( True ) / Off ( False )
HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/BinaryDatabase/102700') # How to open tutorial link for verification
